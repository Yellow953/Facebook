...
class FriendRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friend_request" do
    assert_difference("FriendRequest.count") do
      post friend_requests_url, params: { friend_request: { from: @friend_request.from, to: @friend_request.to } }
    end
  ...
  test "should update friend_request" do
    patch friend_request_url(@friend_request), params: { friend_request: { from: @friend_request.from, to: @friend_request.to } }
